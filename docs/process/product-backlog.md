...
| PBI-E03 | Produce Requirements v2 | Define observable behavior and quality constraints before design | Highest | Not started | CR-001 requested outcome | Requirements are approved, testable, traced, and contain no excluded scope | Committed Stage 2 record and approved PBI-E02 | 3 |
