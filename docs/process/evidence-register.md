...
| EV-07 | Structured Purchase Request input is validated before approval | Domain validation and submission API tests | Verified |
...
| EV-13 | Report and UML sources are versioned and the final report is generated | Build script, artifact register, post-build visual review | Verified at final build |
| EV-14 | Professor approved the Workflow Management System direction and accepted orchestration/choreography as complex functionalities | Final reconciliation brief | Claimed only at this scope; Purchase Request scenario not separately claimed as approved |
