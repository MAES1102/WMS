...
- Checkpoint-4 rows name the accepted ADR/UML architecture baseline; future checkpoints remain controlled references without inventing an implementation class, endpoint, schema, or executable test.
- Every traceability cell contains a concrete value or a controlled future-evidence statement.

Controlled checkpoint-evidence wording:

- `A4`: Accepted checkpoint-4 architecture evidence in [architecture decisions](../architecture/architecture-decisions.md), [architecture overview](../architecture/architecture-overview.md), [architecture traceability](../architecture/architecture-traceability.md), and the named UML source; the approved design evidence provides no implementation or runtime evidence; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref.
...
|---|---|---|---|---|---|---|
| `FR-001` | CR-001 conditional graph and explicit nodes/transitions | PBI-E06 | EV-018, EV-019 | Definition inspection and graph test | `A4`: ADR-002, ADR-003; domain model, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-002` | Minimal rule 1: exactly one designated start | PBI-E06 | EV-019; CR-001 transition impact | Invalid-definition test | `A4`: ADR-003; domain model, routing/retry activity, run state; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-003` | Minimal rule 1: reachable terminal exists | PBI-E06 | EV-019; CR-001 transition impact | Invalid-definition test | `A4`: ADR-003; domain model, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-004` | Minimal rule 2: every task reachable | PBI-E06 | EV-019 | Graph-reachability test | `A4`: ADR-003; domain model, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-005` | Minimal rule 3; arbitrary-cycle exclusion | PBI-E06, PBI-E09 | EV-022, RK-005 | Self-edge and directed-cycle rejection tests | `A4`: ADR-003; domain model, routing/retry activity; `T6` | Approved baseline requirement; archive cycle artifacts remain comparison evidence; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-006` | CR-001 complete definition validation before execution, including attempt bounds | PBI-E06 | CR-001 impact analysis, RK-005 | Validation-path inspection and rejection-with-no-execution-state tests | `A4`: ADR-003, ADR-006; system context/use cases, both sequence views, routing/retry activity, run state; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-007` | CR-001 `SUCCESS`/`FAILURE`/`ALWAYS` conditions | PBI-E06 | EV-019 | Condition-domain validation test | `A4`: ADR-003; domain model, routing/retry activity; `T6` | Approved baseline requirement; archive source presence is not runtime proof; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-008` | Minimal rule 4: outcome-specific precedence | PBI-E06 | EV-019 | Resolver and trace-selection test | `A4`: ADR-003; both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-009` | Minimal rule 5: `ALWAYS` fallback | PBI-E06 | EV-019 | Resolver fallback test | `A4`: ADR-003; both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-010` | Minimal rule 6: reject equal-precedence ambiguity | PBI-E06 | CR-001 transition impact | Duplicate-eligibility rejection test | `A4`: ADR-003; routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-011` | Minimal rule 7: successful terminal | PBI-E06 | CR-001 transition impact | Terminal-semantics test | `A4`: ADR-003; both sequence views, routing/retry activity, run state; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-012` | Minimal rule 7: unsuccessful terminal | PBI-E06 | CR-001 transition impact | Terminal-semantics test | `A4`: ADR-003; both sequence views, routing/retry activity, run state; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-013` | CR-001 one shared workflow model | PBI-E05, PBI-E06 | EV-019, EV-020, RK-004 | Design review and cross-mode definition identity check | `A4`: ADR-001, ADR-002; component view, domain model; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-014` | CR-001 shared transition-resolution rule set | PBI-E06 | EV-019, RK-004 | Paired resolver and trace comparison | `A4`: ADR-003; component view, both sequence views, routing/retry activity; `T6` | Approved baseline requirement; the accepted shared resolver design is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-015` | CR-001 centralized orchestration | PBI-E07 | EV-018, EV-019 | Orchestration acceptance cases | `A4`: ADR-004; component view, orchestration sequence; `T6` | Approved baseline requirement; baseline source presence is not current runtime proof; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation has not started |
| `FR-016` | CR-001 in-memory EventBus choreography | PBI-E08 | EV-018, EV-019, EV-023, EV-024 | Choreography acceptance cases without broker | `A4`: ADR-005; component view, choreography sequence, deployment view; `T6` | Approved baseline requirement; Kafka runtime remains `UNVERIFIED` and excluded; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation has not started |
| `FR-017` | Minimal rule 11; semantic parity | PBI-E07, PBI-E08, PBI-E10 | RK-004 | Paired normalized-trace comparison | `A4`: ADR-003, ADR-004, ADR-005, ADR-007; both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; the six cases have not been executed |
| `FR-018` | CR-001 run-specific execution state | PBI-E05 | EV-020, EV-021, RK-003 | Run-state association inspection | `A4`: ADR-002, ADR-006; domain model, component view, run state; `T6` | Approved baseline requirement; archive artifacts remain comparison evidence; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation has not started |
| `FR-019` | CR-001 sequential run isolation | PBI-E05 | EV-020, RK-003 | Repeated-run isolation test | `A4`: ADR-002, ADR-004, ADR-005, ADR-006; domain model, component view, run state; `T6` | Approved baseline requirement; archive test definitions are not pass evidence; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; verification has not started |
| `FR-020` | CR-001 concurrent run isolation | PBI-E05 | EV-020, RK-003 | Controlled-concurrency isolation test | `A4`: ADR-002, ADR-004, ADR-005, ADR-006; component view, choreography sequence, run state; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-021` | Minimal rule 8: positive maximum-total-attempt bound for every task | PBI-E09 | RK-005 | Attempt-bound validation and boundary tests | `A4`: ADR-003; domain model, both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-022` | Minimal rule 8: retry if and only if the bound remains | PBI-E09 | EV-022, RK-005 | Two-sided boundary tests proving the required retry below the bound and prohibited retry at the bound for bounds one and two | `A4`: ADR-003; both sequence views, routing/retry activity; `T6` | Approved baseline retry rule; the archive loop counter is not accepted behavior; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation has not started |
| `FR-023` | Minimal rule 9: persistent attempt state | PBI-E05, PBI-E09 | EV-020, RK-005 | Attempt-state persistence inspection | `A4`: ADR-002, ADR-003, ADR-006; domain model, both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-024` | Minimal rule 9: retry without graph edge | PBI-E09 | EV-022, RK-005 | Retry trace inspection | `A4`: ADR-003; both sequence views, routing/retry activity; `T6` | Approved baseline retry rule; cycle-capable prototype behavior is excluded; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation has not started |
| `FR-025` | Minimal rule 10: resolution after exhaustion | PBI-E09 | EV-019, EV-022, RK-005 | Exhaustion resolver test | `A4`: ADR-003; both sequence views, routing/retry activity; `T6` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
| `FR-026` | CR-001 persistent execution trace | PBI-E05, PBI-E10 | CR-001 impact analysis, RK-004, RK-011 | Trace-content and restart test | `A4`: ADR-002, ADR-004, ADR-005, ADR-006; component view, domain model, both sequence views, run state; `T6`; `D8` | Approved baseline requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; no trace execution evidence exists, and implementation has not started |
...
| `NFR-005` | CR-001 system-wide completeness of pre-execution validation | PBI-E06, PBI-E10 | RK-005 | Validation-path inspection plus parameterized invalid, valid-boundary, and combined-violation cases | `A4`: ADR-003; routing/retry activity, run state; `T6` | Approved baseline quality requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
...
| `NFR-007` | CR-001 sequential and concurrent isolation | PBI-E05, PBI-E10 | EV-020, EV-021, RK-003 | State-partition comparison | `A4`: ADR-002, ADR-004, ADR-005, ADR-006; domain model, component view, choreography sequence, run state; `T6` | Approved baseline quality requirement; accepted checkpoint-4 design mapping is approved; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation and verification have not started |
...
| One shared workflow model | `FR-013` | PBI-E05, PBI-E06 | EV-019, EV-020; accepted ADR-001/ADR-002 and component/domain views are approved checkpoint-4 design evidence; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref |
...
| UML or ADR decisions | `CON-010` | Requirements content inspection | Requirements v2 remains design-neutral; checkpoint-4 ADR/UML artifacts are accepted design evidence, with Git durability established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref |
...
- Checkpoint-4 architecture/ADR/UML passed substantive project review and is the approved design baseline; Git durability is established by commit f44f0d55349af4e7b1b19b49f5e3b26c67c96181 and the independently verified origin/refactor/defense-core ref; implementation, executable tests, deployment, and release remain not started.
